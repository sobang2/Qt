...
void QScale::paintEvent(QPaintEvent*)
{
    ...
    painter->setPen(Qt::green);//QPen(palette().color(QPalette::Base), 2));
...
/*    QFont font = painter->font();
    ...
    painter->drawText( QPointF(static_cast<int>(center.x()-Size.width()/2),static_cast<int>(center.y()-u*1)) , str);
//    painter->drawText(QRect(center.x()-u*.2,center.y()-u*1,35,20),str);
    delete painter;
}
